...
<head>
    ...
    <title>Study Case, Sophie Bernard Photography - Mathieu Claessens</title>
</head>
<body>
	<div class="studyCase section">
		<div class="section-wrap">
			<h1 class="section-title">Study Case - Sophie Bernard Photography</h1>
			<div class="studyCase-content">
				<img class="studyCase-img" src="/build/img/portfolio/sbPhoto/sbPhoto.jpg" srcset="/build/img/portfolio/sbPhoto/sbPhoto-320.jpg 320w, /build/img/portfolio/sbPhoto/sbPhoto-440.jpg 440w" alt="Image du projet de Sophie Bernard Photography">
				<p class="studyCase-description">I spent a 12 weeks internship at EXIT Studio as a Front-End Developer & Designer. During this internship they asked me to design and integrate Sophie Bernard’s website. There was already a design when I took over the project but I still had a lot of work to get to the final design. Once I had the final design, I integrated it with wordpress.</p>
			</div>
			<a class="studyCase-link btn btn-primary" href="https://sophiebernardphotography.be/" title="Access the website of Sophie Bernard Photography" target="_blanc">Go to the project</a>
