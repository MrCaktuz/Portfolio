<?php
    ...
    {
      $labels = array(
        'name' => _x('Mes accomplissements', 'post type general name'),
        'singular_name' => _x('Accomplissement', 'post type singular name'),
        'add_new' => _x('Ajouter un accomplissement', 'Accomplissements'),
        'add_new_item' => __('Ajouter un accomplissement'),
        'edit_item' => __('Editer'),
        'new_item' => __('Nouvel accomplissement'),
        'view_item' => __('Voir le contenu'),
        'search_items' => __('Rechercher un accomplissement'),
        'not_found' =>  __('Pas d\'accomplissement'),
        'not_found_in_trash' => __('Pas de contenu dans la corbeille'),
        'parent_item_colon' => '',
        'menu_name' => 'Accomplissements'
      );
