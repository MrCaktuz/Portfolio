...
<head>
    ...
    <title>Study Case, RBC Ciney - Mathieu Claessens</title>
</head>
<body>
	<div class="studyCase section">
		<div class="section-wrap">
			<h1 class="section-title">Study Case - RBC Ciney</h1>
			<div class="studyCase-content">
				<img class="studyCase-img" src="/build/img/portfolio/rbcciney/rbcciney.jpg" srcset="/build/img/portfolio/rbcciney/rbcciney-320.jpg 320w, /build/img/portfolio/rbcciney/rbcciney-440.jpg 440w" alt="Image du projet du RBC Ciney">
				<p class="studyCase-description">As part of my studies I had to pick a final project. I desided to redesign my basketball club's website. I took the challenge to use the framework Laravel. Since I never used Laravel before it was a risk for me to code my end of study's project but I am glad I had the opportunity to learn Laravel and I took it. Now my project is done I can't wait to code more with Laravel.</p>
			</div>
			<a class="studyCase-link btn btn-primary" href="http://rbcciney.mathieuclaessens.be" title="Access the website of RBC Ciney" target="_blanc">Go to the project</a>
